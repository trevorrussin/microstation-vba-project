"""Round-trip check for Data/sheet-specs/619-423.json (Family 1).

Run: python Bridge/roundtrip/619-423.py
"""
...
spec = json.loads((ROOT / "Data/sheet-specs/619-423.json").read_text(encoding="utf-8"))
...
need = ['G20-2', 'NYW8-33', 'W4-2L', 'W20-1', 'W20-5']
for code in need:
