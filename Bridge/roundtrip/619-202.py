"""Round-trip check for Data/sheet-specs/619-202.json (Family 1).

Run: python Bridge/roundtrip/619-202.py
"""
...
spec = json.loads((ROOT / "Data/sheet-specs/619-202.json").read_text(encoding="utf-8"))
...
need = ['NYW8-33', 'W4-2L', 'W20-1', 'WARNING FLAG']
for code in need:
