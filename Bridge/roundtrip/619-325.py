"""Round-trip check for Data/sheet-specs/619-325.json (Family 1).

Run: python Bridge/roundtrip/619-325.py
"""
...
spec = json.loads((ROOT / "Data/sheet-specs/619-325.json").read_text(encoding="utf-8"))
...
pdf_rows = extract_taper((100, 450, 780, 630), ytol=10, has_shoulder=True)
...
raw = group_rows(words_in_window(W, *(90, 320, 450, 440)), y_tol=8.0)
...
raw = group_rows(words_in_window(W, *(90, 630, 500, 760)), y_tol=5.0)
