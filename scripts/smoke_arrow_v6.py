"""Smoke: restore E/W/N tips; south-only +180; 3 into / 2 after."""
...
r1 = wztc_ops.place_orthogonal_intersection(
    ...
    primary_lanes=4,
    secondary_lanes=2,
    reason="arrow QA v6 tips restored + south fix",
)
print("shared", r1.get("status"))
...
r2 = wztc_ops.place_orthogonal_intersection(
    ...
    secondary_lanes=2,
    primary_lanes_out=2,
    reason="arrow QA v6 3into 2after",
)
print("drop", r2.get("status"))
...
for name, cx, cy, w in [
    ("qa_v6_shared", jx, jy, 280),
    ("qa_v6_west", jx - 80, jy, 110),
    ("qa_v6_south", jx, jy - 85, 110),
    ("qa_v6_drop", jx + 500, jy, 320),
    ("qa_v6_drop_east", jx + 580, jy, 140),
]:
